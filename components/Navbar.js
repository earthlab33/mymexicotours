  ...
  return (
    <nav className="flex justify-between items-center py-2 bg-black p-2 mt-0 fixed max-w-7xl w-full z-10 top-0">
      ...
      <div className="flex">
        ...
        <div
          className="offcanvas offcanvas-end fixed bottom-0 flex flex-col max-w-full bg-black invisible bg-clip-padding shadow-sm outline-none transition duration-300 ease-in-out text-white top-0 right-0 border-none w-96"
          tabindex="-1"
          id="offcanvasRight"
        ...
        >
          <div className="offcanvas-header flex items-center justify-between p-4">
            ...
            <button
              type="button"
              className="btn-close box-content w-4 h-4 p-2 -my-5 -mr-2 text-white border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-white hover:opacity-75 hover:no-underline"
